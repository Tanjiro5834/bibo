...
@section('content')
    ...
    <div class="col-12 col-lg mt-4 mt-lg-0" id="curriculumApp">

        <h2 class="fw-bold">My Curriculum</h2>
    ...
    <script>
        const curriculumApp = new Vue({
            el: '#curriculumApp',
            data() {
                return {
                    message: 'DepEd-aligned learning path for Bacoor\'s future leaders',
                };
            },
            methods: {},
        });
